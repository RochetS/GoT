 ...
 * @generated
 */
public class GoTSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case GoTPackage.CHARACTER: {
			got.model.GoT.Character character = (got.model.GoT.Character) theEObject;
		...
		case GoTPackage.GO_T: {
			GoT goT = (GoT) theEObject;
			T result = caseGoT(goT);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	 ...
	 * @generated
	 */
	public T caseCharacter(got.model.GoT.Character object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Go T</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Go T</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseGoT(GoT object) {
		return null;
	}
